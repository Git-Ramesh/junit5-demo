...
public class MathUtilTest2 {
    ...
    @BeforeEach
    private void setUpBeforeEach(TestInfo testInfo, TestReporter testReporter) {
    ...
    public void testComputeCircleArea(RepetitionInfo repetitionInfo) {
        System.out.println(repetitionInfo); // DefaultRepetitionInfo [currentRepetition = 1, totalRepetitions = 3]
        double expected = 2 * Math.PI * 10;
        double actual = mathUtil.computeCircleArea(10);
    ...
    class AddTest {
        ...
        public void testAddPossitiveNumbers() {
            ...
            // assertEquals(expected, actual, "should return result " + expected + " but was returned " +  actual);
            assertEquals(expected, actual, () -> "should return result " + expected + " but was returned " + actual);
        }
